...
namespace MusicCollectionTest.ToolBox
{
    ...
    class LookUpImplTester
    {
        private LookUpImpl<string, MyObject> _LookUp;
        private LookUpImpl<int, MyObject> _LookUp2;
        private LookUpImpl<string, MyObject> _LookUp3;
        private LookUpImpl<int, MyObject> _LookUp4;
        ...
        public void SetUp()
        {
            _LookUp = new  LookUpImpl<string, MyObject>(o=>o.Name,10);
            _LookUp2 = new LookUpImpl<int, MyObject>(o=>o.Value,10);
            _LookUp3 = new LookUpImpl<string, MyObject>(o => string.Format("{0} {1}",o.Name,o.Value),10);
            _LookUp4 = new LookUpImpl<int, MyObject>(o => o.Name.Length,10);
        ...
        private void TestLookUpMonoRes<T, TK>(LookUpImpl<TK, T> entry, TK Entry, T res) where T:class
        {
            ...
            entry.Contains(Entry).Should().BeTrue();
        }
        ...
        {
            Assert.That((from o in _LookUp select o.Key).OrderBy(o => o).SequenceEqual(_Keys.OrderBy(o => o)), Is.True);
            ...
            TestLookUpMonoRes(_LookUp, "a",_Un);
            ...
            TestLookUpNullRes(_LookUp, "g");
           

            Assert.That((from o in _LookUp2 select o.Key).OrderBy(o => o).SequenceEqual(_IntKeys.OrderBy(o => o)), Is.True);
            Assert.That((from o in _LookUp2 from el in o select el).OrderBy(o => o.Name).SequenceEqual(_Elements.OrderBy(o => o.Name)), Is.True);
            Assert.That(_LookUp2.AllElements.OrderBy(o => o.Name).SequenceEqual(_Elements.OrderBy(o => o.Name)), Is.True);
        }

        [Test]
        public void BasicTest2()
        {
            bool res =_LookUp.Remove(_Un);
            Assert.That(res, Is.True);
            res = _LookUp2.Remove(_Un);
            Assert.That(res, Is.True);
            _Keys.Remove(_Un.Name);
            _IntKeys.Remove(_Un.Value);
