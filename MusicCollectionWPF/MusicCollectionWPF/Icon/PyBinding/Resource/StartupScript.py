...
def ComplexityIsNeeded(iText,iFontFamily,iFontStyle,iFontWeight,iFontStretch,iFontSize,iMi1,iMi2):
...
def SpaceCheckerStatus(fs):
    return String.Format('{0} missing', -fs) if (fs.SizeInByte < 0) else String.Format('{0} free', fs)
